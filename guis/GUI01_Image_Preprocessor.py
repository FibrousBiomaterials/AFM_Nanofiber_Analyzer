...
class SettingsDialog(tk.Toplevel):
    ...
    def _build_bg_section(self, plf: ttk.LabelFrame) -> None:
        ...
        self._add_fields(lf_bg, [
            ...
            # Mask dilation parameters shared by trendfill and spline1d.
        ...
        sections = [
            (_("Segmenter"), [
                ...
                ("field", "ridge_min_width_nm", "ridge_min_width_nm",
                 _("[ridge_recovery時] リッジフィルタが探索する繊維半幅の下限") + " (nm)", {"width": 10}),
                ("field", "ridge_max_width_nm", "ridge_max_width_nm",
                 _("[ridge_recovery時] リッジフィルタが探索する繊維半幅の上限") + " (nm)", {"width": 10}),
            ]),
            (_("Skeletonizer"), [
